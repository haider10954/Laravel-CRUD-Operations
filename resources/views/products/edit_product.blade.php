                ...
                <div class="col-lg-12 padding-top-20 ">
                    <form class="row" method="POST" action="{{ route('product.update',$product->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Product Name" name="name" value="{{old('product_name',$product->name)}}">
                            @error('product_name')
                        ...
                        <div class="form-group col-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Product Description" value="{{old('description',$product->description)}}" name="description">
                            @error('description')
                            <p class="badge" style="color:red;">{{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Product Prize" value="{{old('prize',$product->prize)}}" name="prize">
                            @error('prize')
                            <p class="badge" style="color:red;">{{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Product Quantity" value="{{old('quantity',$product->quantity)}}" name="quantity">
                            @error('quantity')
                            <p class="badge" style="color:red;">{{$message}}</p>
                            @enderror
                        </div>
